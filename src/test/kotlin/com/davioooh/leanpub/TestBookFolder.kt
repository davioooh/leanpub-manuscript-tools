...
class TestBookFolder(val bookRootFolder: Path) {
    ...
    fun withFakeChapters(numberOfChapters: Int, chaptersExt: String = TXT_EXT): TestBookFolder {
        repeat(numberOfChapters) {
            createFakeChapterFile(it + 1, chaptersExt)
        }
        return this
    }
    ...
    private fun createFakeChapterFile(chapterNum: Int, fileExt: String): Unit =
        manuscriptFolder
